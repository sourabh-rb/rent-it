...
public class TestClass {
	...
	// int iYear) {
	public ModelWrapper getVehiclesTestDatAfterSearch(String make, String type, String model, String iYear,
	...
	public List<ModelWrapper> gettransactionTestDataAfterSearch(String cname, String vehicle, String duedate,
			String startdate) {
		// TODO Auto-generated method stub
		return null;
	}
